...
public class BorrowingTM {
    ...
    public BorrowingTM(String borrowingId, String bookId, String memberId, LocalDate borrowDate, LocalDate dueDate,
    ...
    public String toString() {
        return "BorrowingTM [borrowingId=" + borrowingId + ", bookId=" + bookId + ", memberId=" + memberId
